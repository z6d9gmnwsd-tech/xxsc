    ...
    <div className="pb-24 min-h-screen" style={{ backgroundColor: '#FEFCF9' }}>
      ...
      <div className="relative overflow-hidden">
        <div
          ...
          style={{ background: 'linear-gradient(145deg, #FF8C5A 0%, #FF7A45 30%, #FF6B35 70%, #E5784A 100%)' }}
        />
        <div
            ...
            {menuItems.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#FEFCF9' }}>
                    {item.icon}
                  </div>
              ...
              <div key={item.label}>
                {item.href ? (
                  <a
                    href={item.href}
                    className="flex items-center justify-between px-4 py-4 active:scale-[0.98] transition-all duration-200"
                    style={{ borderBottom: index < settingItems.length - 1 ? '1px solid #F3F4F6' : 'none' }}
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#FEFCF9' }}>
                        {item.icon}
